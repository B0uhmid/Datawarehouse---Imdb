...
package datawarehouseproject.actor_0_1;
 ...
 * @status
 */
public class actor implements TalendJob {
	...
	private final String jobName = "actor";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(actor.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_DATAWAREHOUSEPROJECT_actor = new byte[0];
		static byte[] commonByteArray_DATAWAREHOUSEPROJECT_actor = new byte[0];
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime * result + ((this.id_acteur == null) ? 0 : this.id_acteur.hashCode());
		...
		public boolean equals(Object obj) {
			...
			if (this.id_acteur == null) {
				if (other.id_acteur != null)
					return false;

			} else if (!this.id_acteur.equals(other.id_acteur))
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DATAWAREHOUSEPROJECT_actor.length) {
					if (length < 1024 && commonByteArray_DATAWAREHOUSEPROJECT_actor.length == 0) {
						commonByteArray_DATAWAREHOUSEPROJECT_actor = new byte[1024];
					} else {
						commonByteArray_DATAWAREHOUSEPROJECT_actor = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DATAWAREHOUSEPROJECT_actor, 0, length);
				strReturn = new String(commonByteArray_DATAWAREHOUSEPROJECT_actor, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_DATAWAREHOUSEPROJECT_actor, 0, length);
				strReturn = new String(commonByteArray_DATAWAREHOUSEPROJECT_actor, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DATAWAREHOUSEPROJECT_actor) {

				try {

					int length = 0;

					this.id_acteur = readInteger(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeInteger(this.id_acteur, dos);
		...
		public int compareTo(row2Struct other) {
			...
			returnValue = checkNullsAndCompare(this.id_acteur, other.id_acteur);
			if (returnValue != 0) {
				return returnValue;
			}
	...
	public static class actorStruct implements routines.system.IPersistableRow<actorStruct> {
		final static byte[] commonByteArrayLock_DATAWAREHOUSEPROJECT_actor = new byte[0];
		static byte[] commonByteArray_DATAWAREHOUSEPROJECT_actor = new byte[0];
		protected static final int DEFAULT_HASHCODE = 1;
		protected static final int PRIME = 31;
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final actorStruct other = (actorStruct) obj;
		...
		public void copyDataTo(actorStruct other) {
		...
		public void copyKeysDataTo(actorStruct other) {
		 ...
		 * Compare keys
		 */
		public int compareTo(actorStruct other) {
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String tableName_tDBOutput_1 = "acteurs";
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:ztk3CwxqQpSxWWnjA/2Vco6lKVA3Ymo6kjvzWg==");
				...
				while (rsTable_tDBOutput_1.next()) {
					...
					if (table_tDBOutput_1.equalsIgnoreCase("acteurs")) {
				...
				try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
					stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1
							+ "`(`id_acteur` INT(0)  ,`cast` VARCHAR(100)  ,primary key(`id_acteur`))");
				}

				String insert_tDBOutput_1 = "INSERT INTO `" + "acteurs" + "` (`id_acteur`,`cast`) VALUES (?,?)";
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "actor");
				}
...
// # Outputs initialization
				actorStruct actor_tmp = new actorStruct();
// ###############################
...
// # Output table : 'actor'
								actor_tmp.id_acteur = Numeric.sequence("id_acteur", 1, 1);
								actor_tmp.cast = row1.cast.contains("|")
										? row1.cast.substring(0, row1.cast.indexOf("|"))
										: row1.cast;
								actor = actor_tmp;
// ###############################
...
// Start of branch "actor"
							if (actor != null) {
								...
								row2 = null;
								finder_tUniqRow_1.id_acteur = actor.id_acteur;
								finder_tUniqRow_1.hashCodeDirty = true;
								if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
									KeyStruct_tUniqRow_1 new_tUniqRow_1 = new KeyStruct_tUniqRow_1();

									new_tUniqRow_1.id_acteur = actor.id_acteur;
									...
									row2.id_acteur = actor.id_acteur;
									row2.cast = actor.cast;
...
// Start of branch "row2"
								if (row2 != null) {
									...
									if (row2.id_acteur == null) {
										pstmt_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(1, row2.id_acteur);
									}

									if (row2.cast == null) {
										pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(2, row2.cast);
									}
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "actor");
				}
	...
	public static void main(String[] args) {
		final actor actorClass = new actor();

		int exitCode = actorClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = actor.class.getClassLoader()
					.getResourceAsStream("datawarehouseproject/actor_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = actor.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : actor");
		}
...
/************************************************************************************************
 * 113916 characters generated by Talend Open Studio for Data Integration on the
 * 6 décembre 2024, 08:55:44 CET
 ************************************************************************************************/