...
package datawarehouseproject.entreprises_0_1;
 ...
 * @status
 */
public class entreprises implements TalendJob {
	...
	private final String jobName = "entreprises";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(entreprises.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_DATAWAREHOUSEPROJECT_entreprises = new byte[0];
		static byte[] commonByteArray_DATAWAREHOUSEPROJECT_entreprises = new byte[0];
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime * result + ((this.id_Entreprise == null) ? 0 : this.id_Entreprise.hashCode());
		...
		public boolean equals(Object obj) {
			...
			if (this.id_Entreprise == null) {
				if (other.id_Entreprise != null)
					return false;

			} else if (!this.id_Entreprise.equals(other.id_Entreprise))
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DATAWAREHOUSEPROJECT_entreprises.length) {
					if (length < 1024 && commonByteArray_DATAWAREHOUSEPROJECT_entreprises.length == 0) {
						commonByteArray_DATAWAREHOUSEPROJECT_entreprises = new byte[1024];
					} else {
						commonByteArray_DATAWAREHOUSEPROJECT_entreprises = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DATAWAREHOUSEPROJECT_entreprises, 0, length);
				strReturn = new String(commonByteArray_DATAWAREHOUSEPROJECT_entreprises, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_DATAWAREHOUSEPROJECT_entreprises, 0, length);
				strReturn = new String(commonByteArray_DATAWAREHOUSEPROJECT_entreprises, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DATAWAREHOUSEPROJECT_entreprises) {

				try {

					int length = 0;

					this.id_Entreprise = readInteger(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeInteger(this.id_Entreprise, dos);
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String tableName_tDBOutput_1 = "Réalisateurs";
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:xw9NOHzPPHWnx6afGcvDhAAed/Qy4l28AqS6TA==");
				...
				while (rsTable_tDBOutput_1.next()) {
					...
					if (table_tDBOutput_1.equalsIgnoreCase("Réalisateurs")) {
				...
				try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
					stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1
							+ "`(`id_Entreprise` INT(0)  ,`production_companies` VARCHAR(120)  ,`director` VARCHAR(100)  ,primary key(`id_Entreprise`))");
				}

				String insert_tDBOutput_1 = "INSERT INTO `" + "Réalisateurs"
						+ "` (`id_Entreprise`,`production_companies`,`director`) VALUES (?,?,?)";
				...
				class KeyStruct_tUniqRow_1 {
					...
					public int hashCode() {
						if (this.hashCodeDirty) {
							...
							result = prime * result
									+ ((this.id_Entreprise == null) ? 0 : this.id_Entreprise.hashCode());
...
// # Output table : 'Entreprises'
								Entreprises_tmp.id_Entreprise = Numeric.sequence("id_Entreprise", 1, 1);
								Entreprises_tmp.production_companies = row1.production_companies.contains("|")
										? row1.production_companies.substring(0, row1.production_companies.indexOf("|"))
										: row1.production_companies;
								Entreprises_tmp.director = row1.director;
...
// Start of branch "Entreprises"
							if (Entreprises != null) {
								...
								row2 = null;
								finder_tUniqRow_1.id_Entreprise = Entreprises.id_Entreprise;
								finder_tUniqRow_1.hashCodeDirty = true;
								if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
									KeyStruct_tUniqRow_1 new_tUniqRow_1 = new KeyStruct_tUniqRow_1();

									new_tUniqRow_1.id_Entreprise = Entreprises.id_Entreprise;
									...
									row2.id_Entreprise = Entreprises.id_Entreprise;
									row2.production_companies = Entreprises.production_companies;
									row2.director = Entreprises.director;
...
// Start of branch "row2"
								if (row2 != null) {
									...
									if (row2.id_Entreprise == null) {
										pstmt_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(1, row2.id_Entreprise);
									}

									if (row2.production_companies == null) {
										pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(2, row2.production_companies);
									}

									if (row2.director == null) {
										pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(3, row2.director);
									}
...
// ###############################      
	...
	public static void main(String[] args) {
		final entreprises entreprisesClass = new entreprises();

		int exitCode = entreprisesClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = entreprises.class.getClassLoader()
					.getResourceAsStream("datawarehouseproject/entreprises_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = entreprises.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : entreprises");
		}
...
/************************************************************************************************
 * 116390 characters generated by Talend Open Studio for Data Integration on the
 * 3 décembre 2024, 16:40:59 CET
 ************************************************************************************************/